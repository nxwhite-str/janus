...
void printUsage()
{
    printf("Usage: janus_create_templates2 sdk_path temp_path data_path metadata_file templates_dir template_list_file template_role [-gpuindex <index>] [-algorithm <algorithm>] [-verbose]\n");
}
...
int main(int argc, char *argv[])
{
    ...
    JANUS_ASSERT(janus_create_templates2_helper(argv[3], argv[4], argv[5], argv[6], static_cast<janus_template_role>(atoi(argv[7])), verbose))
