...
void printUsage()
{
  printf("Usage: janus_create_templates_parallel sdk_path temp_path data_path metadata_file templates_dir template_list_file flat_template_list_file gpu_index [-algorithm <algorithm>] [-verbose] [-tuning_data <csvfile>]\n");
}
